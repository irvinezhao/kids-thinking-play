...
- 原创题库：每个年龄段 120 道生成式原创题，共 360 道
- 题型模板：普通选择、拖拽分类、连线配对、找阴影、路径迷宫、左右判断
- 即时反馈：答对等待 2 秒自动下一题；答错等待 2 秒重新作答
- 家长模式：错题记录、能力雷达、每日练习时长、近况正确率
...
1. 把题库生成器升级为人工精选题库，保留生成器做占位和批量扩展
2. 给拖拽、连线、迷宫增加更强的触摸手势和动效
